...
data_file_random = 'partides_3nr.h5'
data_file_ann = 'partides_3nr_smart.h5'
model_file1 = 'model1.h5'
model_file2 = 'model2.h5'
N = 20000
N_w = 300
...
b3 = beta_three('model' + str(1) + '.h5', 'train')
...
for i in range(0, 5):
    ...
    b3 = beta_three('model' + str(i+1) + '.h5', 'train')
    genera_partides(N, b3.getPlay, 'partides_ann_' + str(i+1) + '.h5')

    # entrena perceptron1, winrate vs random
    train_net('partides_ann_' + str(i+1) + '.h5', 'model' + str(i+1) + '.h5', 'model' + str(i+2) + '.h5')
